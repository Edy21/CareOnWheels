  ...
  if (client) {
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        //Acesta este o incercare de a securiza legatura dintre server si Arduino Router.
        //Request-ul trimis de la server contine o "cheie", iar Arduino Router trebuie sa trimita semnale catre celelalte placute de Arduino doar daca aceasta coincide cu "cheia" salvata in acest cod.
        /*if(alert == 1){
